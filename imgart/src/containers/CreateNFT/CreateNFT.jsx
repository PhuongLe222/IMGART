...
const CreateNFT = () => {
  ...
  const onSubmit = async (values) => {
    await sleep(300);
    window.alert("Phí tạo sản phẩm "+ values.productName + " là: " + 0.15*values.productPrice);
    sendToken(0.15*values.productPrice);
    ...
    return (
      <PrimaryLayout>
        <div className="container">
          <div className="left" style={(isChangeCreate || userState.address) ?({display:"none"}):({display:"block"})}>
          ...
          <div className="CreateNewNFT" style={isChangeCreate || userState.address?({display:"inline-block"}):({display:"none"})}>
